...
For this video, we’ll need a few things from your Elegoo Arduino kit.  I’ll list the items below.  In this lesson we’re going to introduce the DHT11 Temperature and Humidity Sensor provided in the kit and the SimpleDHT Library.  I step through the Elegoo provided code, which uses a Library, and explain how it makes this happen.  We’ll build and configure a simple circuit that is provided in the tutorial to demonstrate the functionality.  Then I’ll discover the limitations of the DHT11 sensor and how to overcome it.   As usual it was a fun project, I hope you enjoy it. 
