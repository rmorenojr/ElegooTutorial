...
[![YouTube video](https://img.youtube.com/vi/y5X2zwbO6e4/0.jpg)](https://youtu.be/gTQmLkwnUxk)
[YouTube video](https://youtu.be/gTQmLkwnUxk)
...
* [Arduino Door Lock Access Control Project by HowToMechatronics](https://howtomechatronics.com/tutorials/arduino/rfid-works-make-arduino-based-rfid-door-lock/)
* [Interfacing RFID with Arduino – How to Read RFID Cards using Arduino](http://www.circuitstoday.com/interfacing-rfid-with-arduino)
* [Security Access Using RFID Reader](https://create.arduino.cc/projecthub/Aritro/security-access-using-rfid-reader-f7c746)
* [RFID How-To: Not only for Arduino (only legal Stuff!)](https://www.youtube.com/watch?v=vEkfa3OMvec)
