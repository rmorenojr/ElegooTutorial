...
For this video, we’ll need a few things from your Elegoo Arduino UNO kit.  I’ll list the items below.  In this lesson we’re going to check out the MAX7219 LED Dot Matrix Module provided in the kit.  I’ll step through the Elegoo provided tutorial and briefly explain how code makes this happen.  We’ll build and configure a simple circuit that is provided in the tutorial to demonstrate the functionality.  The sketch used a software SPI driven Library, and then we’ll install a hardware SPI library and see some of the differences.  I hope you enjoy it. 
