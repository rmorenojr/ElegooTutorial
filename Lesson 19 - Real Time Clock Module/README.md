...
We’ll need a few things from your Elegoo Arduino UNO kit.  I’ll list the items below.  In this lesson we’re going to check out the DS3231 RTC module, aka. ZS-042 module.  The ZS-042 module includes a DS3231 real time clock and calendar, AT24C32N EEPROM chip, and CR3032 battery.  I’ll step through the Elegoo provided tutorial and briefly explain how code makes this happen.  We’ll build and configure a simple circuit that is provided in the tutorial to demonstrate the functionality.  Then will show an alarm clock circuit, complete with snooze alarm, and new SimpleAlarmClock.h library.  I hope you enjoy it. 
